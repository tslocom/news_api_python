...
Then install django within the venv  
...
You can now use the admin panel to view the database and add user tags for testing using python manage.py runserver and go to the localhost link provided but you must add /admin at the end